...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::header','data' => ['container' => true,'class' => 'border-b border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['container' => true,'class' => 'border-b border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950']); ?>
