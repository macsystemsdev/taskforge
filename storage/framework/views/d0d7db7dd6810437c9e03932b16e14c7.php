...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['class' => 'flex min-h-[600px] flex-col overflow-hidden rounded-3xl border border-zinc-200/80 bg-gradient-to-b from-zinc-50/50 to-white shadow-xl shadow-zinc-200/50 backdrop-blur transition-all duration-300 hover:shadow-2xl dark:border-white/10 dark:from-zinc-900/50 dark:to-zinc-950 dark:shadow-black/20']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'flex min-h-[600px] flex-col overflow-hidden rounded-3xl border border-zinc-200/80 bg-gradient-to-b from-zinc-50/50 to-white shadow-xl shadow-zinc-200/50 backdrop-blur transition-all duration-300 hover:shadow-2xl dark:border-white/10 dark:from-zinc-900/50 dark:to-zinc-950 dark:shadow-black/20']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'space-y-6 overflow-hidden rounded-3xl border border-zinc-200/80 bg-white/50 backdrop-blur transition-all duration-300 hover:shadow-xl dark:border-white/10 dark:bg-zinc-900/50']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
