...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::app','data' => ['title' => $task->title]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($task->title)]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.page-header','data' => ['title' => $task->title,'description' => $task->description ?: __('No task description has been added yet.'),'eyebrow' => $task->project->workspace->organization->name.' / '.$task->project->name]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginal5ea2e86292230ce7e0ef1e38c0291982 = $component; } ?>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3611768661-0', $__key);
                    ...
                    <dl class="mt-5 space-y-4 text-sm">
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <dd class="text-right font-medium text-zinc-950 dark:text-white">
                                <a href="<?php echo e(route('projects.show', $task->project)); ?>" class="hover:underline" wire:navigate>
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <dd class="text-right font-medium text-zinc-950 dark:text-white"><?php echo e($task->project->workspace->name); ?></dd>
                        </div>
                        <div class="flex items-center justify-between gap-4">
                            <dt class="text-zinc-500 dark:text-zinc-400">Created</dt>
                            <dd class="text-right font-medium text-zinc-950 dark:text-white"><?php echo e($task->created_at->format('M d, Y')); ?></dd>
                        </div>
                        <div class="flex items-center justify-between gap-4">
                            <dt class="text-zinc-500 dark:text-zinc-400">Updated</dt>
                            <dd class="text-right font-medium text-zinc-950 dark:text-white"><?php echo e($task->updated_at->diffForHumans()); ?></dd>
                        </div>
                    </dl>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Code\taskforge\resources\views\pages\tasks\show.blade.php ENDPATH**/ ?>