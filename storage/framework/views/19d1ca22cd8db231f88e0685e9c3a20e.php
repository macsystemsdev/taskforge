...
<body class="bg-white text-zinc-900 antialiased dark:bg-zinc-950 dark:text-zinc-100">
    ...
    <nav class="fixed top-0 z-50 w-full border-b border-zinc-200 bg-white/90 backdrop-blur dark:border-white/10 dark:bg-zinc-950/90">
        <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('login')); ?>" class="rounded-lg px-4 py-2 text-sm font-medium text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white transition">Log in</a>
                <a href="<?php echo e(route('register')); ?>" class="rounded-lg bg-zinc-900 px-5 py-2 text-sm font-semibold text-white hover:bg-zinc-700 dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-200 transition">Get Started</a>
            </div>
        </div>
    </nav>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mx-auto max-w-3xl text-center">
                ...
                <div class="mt-10 flex flex-col gap-4 sm:flex-row sm:justify-center">
                    <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center rounded-lg bg-zinc-900 px-8 py-4 text-base font-semibold text-white hover:bg-zinc-700 transition">
                        Start Free Trial
                        <span class="ml-2">→</span>
                    </a>
                    <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center rounded-lg border border-zinc-300 bg-white px-8 py-4 text-base font-semibold text-zinc-900 hover:bg-zinc-50 transition">
                        Sign In
                    </a>
                </div>
            </div>
            ...
            <div class="mt-24 text-center">
                ...
                <a href="<?php echo e(route('register')); ?>" class="mt-8 inline-flex items-center justify-center rounded-lg bg-zinc-900 px-10 py-4 text-base font-semibold text-white hover:bg-zinc-700 transition">
                    Get Started
                    <span class="ml-2">→</span>
                </a>
            </div>
    ...
    <footer class="border-t border-zinc-200 py-8 dark:border-white/10">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center text-sm text-zinc-500">
            <a href="<?php echo e(route('about')); ?>" class="hover:text-zinc-700 dark:hover:text-zinc-300">About</a>
            <span class="mx-2">·</span>
            &copy; <?php echo e(date('Y')); ?> TaskForge. All rights reserved.
        </div>
    </footer>
