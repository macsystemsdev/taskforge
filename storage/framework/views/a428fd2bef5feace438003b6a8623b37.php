...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <div class="flex items-center justify-between">
            <div>
                <p class="font-semibold text-zinc-950 dark:text-white">
                    <?php echo e(__('Currently viewing')); ?>
                ...
                <p class="text-sm text-zinc-500 dark:text-zinc-400">
                    ...
                    <?php echo e(\Illuminate\Support\Str::plural(
                        __('member'),
                        count($users)
                    )); ?>
        ...
        <div class="space-y-3">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div
                    <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'presence-user-'.e($user['id']).''; ?>wire:key="presence-user-<?php echo e($user['id']); ?>"
                ...
                >
                    ...
                    >
                        <?php echo e(\Illuminate\Support\Str::upper(
                    ...
                    <div class="min-w-0">
                        ...
                        >
                            <?php echo e(__('Viewing this project')); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                <p class="text-sm text-zinc-500 dark:text-zinc-400">
                    <?php echo e(__('No active viewers.')); ?>
...
<?php endif; ?>
</div><?php /**PATH /var/www/html/resources/views/livewire/projects/project-presence.blade.php ENDPATH**/ ?>