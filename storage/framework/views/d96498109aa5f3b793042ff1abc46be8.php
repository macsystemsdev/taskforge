...
<div <?php echo e($attributes->merge(['class' => 'mb-6 flex flex-col gap-4 border-b border-zinc-200 pb-5 dark:border-white/10 sm:flex-row sm:items-end sm:justify-between'])); ?>>
    <div class="min-w-0">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($actions) || trim((string) $slot)): ?>
...
<?php /**PATH D:\Code\taskforge\resources\views/components/ui/page-header.blade.php ENDPATH**/ ?>