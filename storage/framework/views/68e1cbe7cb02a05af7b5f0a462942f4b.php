...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                ...
                <p class="text-3xl font-semibold tracking-tight text-zinc-950 dark:text-white">
                    <?php echo e($allOrganizations->count()); ?></p>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                ...
                <p class="text-3xl font-semibold tracking-tight text-zinc-950 dark:text-white"><?php echo e($projects->count()); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                ...
                <p class="text-3xl font-semibold tracking-tight text-zinc-950 dark:text-white">
                    <?php echo e($unreadNotifications); ?></p>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93)): ?>
<?php $attributes = $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $projects->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <a href="<?php echo e(route('projects.show', $project)); ?>"
                            ...
                            <div class="flex items-center justify-between gap-3">
                                ...
                                <span
                                    class="text-xs font-medium text-zinc-500 dark:text-zinc-400"><?php echo e($project->tasks->count()); ?>

                                    tasks</span>
                            </div>
                            <p class="mt-1 truncate text-sm text-zinc-500 dark:text-zinc-400">
                                <?php echo e($project->workspace->name); ?></p>
                        </a>
