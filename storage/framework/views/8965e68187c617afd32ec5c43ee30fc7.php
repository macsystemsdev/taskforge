...
<?php endif; ?>
        ...
        <div>
            ...
            <p class="font-medium text-red-600">
                <?php echo e($project->overdueTaskCount()); ?>
        ...
        <div>
            ...
            <p class="font-medium text-amber-600">
                <?php echo e($project->dueSoonTaskCount()); ?>
...
<?php endif; ?>
        ...
        <div>
            ...
            <p>
                <?php echo e($project->due_date?->format('M d, Y') ?? __('No due date')); ?>
