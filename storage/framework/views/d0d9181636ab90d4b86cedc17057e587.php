...
<?php endif; ?>
    ...
    <div class="overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500/90 via-indigo-500/85 to-blue-600/90 p-5 text-white shadow-[0_8px_32px_rgba(37,99,235,0.15)] sm:p-6 backdrop-blur">
        <h1 class="text-2xl font-semibold tracking-tight text-white"><?php echo e(__('Teams')); ?></h1>
        <p class="mt-2 max-w-xl text-sm text-blue-50 sm:text-base"><?php echo e(__('Manage your teams and team memberships.')); ?></p>
    </div>
