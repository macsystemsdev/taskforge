...
<title>
    <?php echo e(filled($title ?? null)
            ? $title . ' - ' . config('app.name', 'TaskForge')
...
<?php echo app('flux')->fluxAppearance(); ?><?php /**PATH /var/www/html/resources/views/partials/head.blade.php ENDPATH**/ ?>