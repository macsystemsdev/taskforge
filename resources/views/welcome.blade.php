        ...
        <div class="mx-auto flex w-full max-w-7xl flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div class="max-w-2xl space-y-8 rounded-[2rem] border border-zinc-200 bg-white/90 p-10 shadow-[0_40px_120px_-50px_rgba(15,23,42,0.2)] backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/85 dark:text-zinc-100">
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                    <a href="{{ route('register') }}" class="inline-flex items-center justify-center rounded-full bg-zinc-950 px-6 py-3 text-sm font-semibold text-white transition hover:bg-zinc-800" wire:navigate>
                        Create account
                    </a>
                    <a href="{{ route('login') }}" class="inline-flex items-center justify-center rounded-full border border-zinc-200 bg-white px-6 py-3 text-sm font-semibold text-zinc-950 transition hover:border-zinc-300 dark:border-zinc-700 dark:bg-zinc-950 dark:text-white dark:hover:border-zinc-500" wire:navigate>
                        Log in
                    </a>
                </div>
