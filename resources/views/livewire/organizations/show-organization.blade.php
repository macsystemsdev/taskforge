            ...
            <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                <x-ui.card class="space-y-2">
                    ...
                    <p class="text-3xl font-semibold tracking-tight text-zinc-950 dark:text-white">
                        {{ $workspaceUsage }} / {{ $workspaceLimit === null ? 'Unlimited' : $workspaceLimit }}
                    </p>
                </x-ui.card>
                ...
                <x-ui.card class="space-y-2">
                    ...
                    <p class="text-3xl font-semibold tracking-tight text-zinc-950 dark:text-white">
                        {{ $projectUsage }} / {{ $projectLimit === null ? 'Unlimited' : $projectLimit }}
                    </p>
                </x-ui.card>
                ...
                <x-ui.card class="space-y-2">
                    ...
                    <p class="text-3xl font-semibold tracking-tight text-zinc-950 dark:text-white">
                        {{ $teamUsage }} / {{ $teamLimit === null ? 'Unlimited' : $teamLimit }}
                    </p>
                </x-ui.card>
                ...
                <x-ui.card class="space-y-2">
                    ...
                    <p class="text-3xl font-semibold tracking-tight text-zinc-950 dark:text-white">
                        {{ $taskUsage }} / {{ $taskLimit === null ? 'Unlimited' : $taskLimit }}
                    </p>
                </x-ui.card>
                ...
                <x-ui.card class="space-y-2">
                    ...
                    <p class="text-3xl font-semibold tracking-tight text-zinc-950 dark:text-white">
                        {{ $memberUsage }} / {{ $memberLimit === null ? 'Unlimited' : $memberLimit }}
                    </p>
                </x-ui.card>
                ...
                <x-ui.card class="space-y-2">
                    ...
                    <p class="text-3xl font-semibold tracking-tight text-zinc-950 dark:text-white">
                        ...
                        {{ $storageLimit === null ? 'Unlimited' : $storageLimit . ' MB' }}
                    </p>
                </x-ui.card>
            </div>
        @endif
        ...
        <flux:modal wire:model="showCreateWorkspaceModal">
            <div class="space-y-6">
                <div>
                    ...
                    <flux:text class="mt-2">Create a new workspace within this organization.</flux:text>
                </div>
                    ...
                    @foreach ($organization->members as $member)
                        <div wire:key="member-{{ $member->id }}"
                            ...
                            <div class="flex min-w-0 items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    <p class="truncate font-medium text-zinc-950 dark:text-white">{{ $member->name }}
                                    </p>
                                    <p class="truncate text-sm text-zinc-500 dark:text-zinc-400">{{ $member->email }}
                                    </p>
                                </div>
                            </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            @forelse ($this->invitations as $invitation)
                                <tr class="tf-row-link" wire:key="invitation-{{ $invitation->id }}">
