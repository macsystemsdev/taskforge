...
<div class="space-y-8">
    ...
    @if ($organization->subscription->canStartTrial())
        <x-ui.card
            class="border-indigo-200 bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow-xl shadow-indigo-950/10">
    ...
    <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        @foreach ($this->plans as $plan)
            ...
            <x-ui.card
                class="flex h-full flex-col border-zinc-200/80 bg-white/90 shadow-sm {{ $current ? 'ring-2 ring-indigo-500/20' : '' }}">
                ...
                <div class="mt-auto pt-8">
                    ...
                    @else
                        <button wire:click="selectPlan({{ $plan->id }})" wire:loading.attr="disabled"
                            ...
                            <span wire:loading.flex wire:target="selectPlan({{ $plan->id }})"
            ...
            <div class="space-y-8">
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <flux:button variant="primary" wire:click="confirmPlanChange" wire:loading.attr="disabled"
                        wire:target="confirmPlanChange" class="inline-flex items-center justify-center gap-2">
